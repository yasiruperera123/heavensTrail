...
import "./floatinReviewPlan.css"; // Import the CSS file for styling

function FloatinReviewPlan() {
  ...
  return (
    <nav className={`floatingReviewPlan ${scrolled ? "scrolled" : ""}`}>
      {/* Logo on the left */}
      <div className="logo">
...
export default FloatinReviewPlan;
